...
class NodesDecommissioningTest(EndToEndTest):
    ...
    def test_recommissioning_node(self):
        ...
        wait_until(lambda: check_status(to_decommission, 'active'),
                   timeout_sec=15,
                   backoff_sec=1)
    ...
    def test_recommissioning_multi_nodes(self):
        ...
        wait_until(lambda: check_status(to_decommission_1, 'draining'),
                   timeout_sec=15,
                   backoff_sec=1)
        wait_until(lambda: check_status(to_decommission_2, 'draining'),
                   timeout_sec=15,
                   backoff_sec=1)
        ...
        wait_until(lambda: check_status(to_decommission_1, 'active'),
                   timeout_sec=15,
                   backoff_sec=1)
