...
private:
    ...
    ss::future<bool>
      is_ready_to_be_removed(ss::lw_shared_ptr<partition>, model::revision_id);
    ...
    ss::future<std::error_code>
    delete_partition(model::ntp, model::revision_id, bool);
    ...
    ss::future<> bootstrap_ntp(model::ntp, deltas_t&);
    ss::future<bool> is_applicable(model::ntp, const topic_table::delta&);
