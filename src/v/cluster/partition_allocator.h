...
public:
    ...
    /// Realocates partitition assignment moving replicas from decommissioned
    /// nodes. Replicas on nodes that are present are left not changed.
    /// Return empty optional if it reallocation is impossible
