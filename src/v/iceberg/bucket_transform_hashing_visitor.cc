...
uint32_t bucket_transform_hashing_visitor::operator()(const string_value&) {
    // TODO: we need iobuf murmurhash3_x86_32
    return 0;
}
uint32_t bucket_transform_hashing_visitor::operator()(const fixed_value&) {
    return 0;
}
uint32_t bucket_transform_hashing_visitor::operator()(const binary_value&) {
    return 0;
}
uint32_t bucket_transform_hashing_visitor::operator()(const uuid_value&) {
    return 0;
}
