...
public:
    ...
    void start();
    void notify_leadership_changed() { _leadership_changed.signal(); }
    void stop();

private:
    ss::future<> dispatch();
    ss::future<> do_dispatch(ss::io_priority_class);

    ss::future<ss::circular_buffer<model::record_batch>>
    read_range(model::offset, ss::io_priority_class, bool);
    ss::future<> replicate(
    ...
    ss::condition_variable _leadership_changed;
};
