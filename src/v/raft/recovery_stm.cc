...
recovery_stm::should_flush(model::offset follower_committed_match_index) const {
    ...
    bool is_last_batch = _last_batch_offset == lstats.dirty_offset;
    bool follower_has_batches_to_commit = follower_committed_match_index
                                          < _ptr->_last_quorum_replicated_index;
    bool last_replicate_with_quorum = _ptr->_last_write_consistency_level
